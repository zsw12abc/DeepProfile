...
const mockIdentifyPlatform = async (
  url: string,
...
describe("ProfileService", () => {
  ...
  describe("identifyPlatform", () => {
    it("should identify zhihu platform", async () => {
      const platform = await mockIdentifyPlatform(
  ...
  describe("fetchUserContent", () => {
    it("should fetch content from Zhihu platform", async () => {
      ...
      expect(ZhihuClient.fetchUserContent).toHaveBeenCalledWith(
        "test-user",
        10,
        undefined,
      );
    ...
    it("should fetch content from Reddit platform", async () => {
      ...
      expect(RedditClient.fetchUserContent).toHaveBeenCalledWith(
        "test-user",
        10,
        undefined,
      );
    ...
    it("should fetch content from Twitter platform", async () => {
      ...
      expect(TwitterClient.fetchUserContent).toHaveBeenCalledWith(
        "test-user",
        10,
        undefined,
      );
    ...
    it("should fetch content from Quora platform", async () => {
      ...
      expect(QuoraClient.fetchUserContent).toHaveBeenCalledWith(
        "test-user",
        10,
        undefined,
      );
    ...
    it("should throw error for unsupported platforms", async () => {
      await expect(
        ProfileService.fetchUserContent(
          "facebook" as SupportedPlatform,
          "test-user",
          10,
        ),
      ).rejects.toThrow("Platform facebook is not implemented yet");
    });
  });
