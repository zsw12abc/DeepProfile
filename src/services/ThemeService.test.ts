...
describe("ThemeService", () => {
  ...
  it("should apply a new theme", async () => {
    ...
    storageMock.get.mockResolvedValueOnce({ deep_profile_config: DEFAULT_CONFIG });
    ...
    storageMock.get
      .mockResolvedValueOnce({ deep_profile_config: { 
        ...DEFAULT_CONFIG, 
  ...
  it("should add a new theme", async () => {
    ...
    expect(configWithNewTheme.themes['new-test-theme'].id).toBe('new-test-theme');
  });
